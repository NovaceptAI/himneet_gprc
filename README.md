...
* Redis: **[Simple Redis service](  /redis)**
  ```
  git clone   /redis.git
  ```
* RabbitMQ: **[Simple RabbitMQ service](  /rabbitmq)**
  ```
  git clone   /rabbitmq.git
  ```
...
in the first time, before up using `docker-compose.join.*` files, create external networks by build **[Redis](  /redis)**, **[RabbitMQ](  /rabbitmq)** and **[Minio]( )** projects.
...
| 3  | docker-compose.join.redis.yml    | to join the Redis service network as an external network. see : **[Redis service](  /redis)**|
| 4  | docker-compose.join.rabbitmq.yml | to join the RabbitMQ service network as an external network. see : **[RabbitMQ service](  /rabbitmq)**|
